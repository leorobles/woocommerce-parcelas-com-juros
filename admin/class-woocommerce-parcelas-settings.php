...
class Woocommerce_Parcelas_Settings{
	...
	public function fswp_admin_menu(){
		add_submenu_page(
			'woocommerce',
			__('WooCommerce Parcelas com e sem Juros',	'woocommerce-parcelas'),
	...
	public function fswp_page_settings(){
		...
		add_settings_field(
			'tipo_pagamento',
			__('Método de Pagamento', 'woocommerce-parcelas'),
			...
			array(
				...
				'desc'		=>	__('Selecione o método de pagamento que você utiliza em sua loja para fazer o calculo das parcelas.', 'woocommerce-parcelas'),
				'default'	=> ''
			)
		);	
